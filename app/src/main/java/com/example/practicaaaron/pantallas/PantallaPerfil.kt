...
@Composable
@Preview
fun VentanaPerfil(navHostController: NavHostController?=null){
            Column (modifier = Modifier
                ...
                Column  (horizontalAlignment = Alignment.CenterHorizontally, modifier = Modifier.fillMaxWidth()){
                    ...
                    Text(text = "Nombre completo", fontSize = 40.sp, fontWeight = FontWeight.Black)
                }

                Spacer(modifier = Modifier.padding(0.dp,0.dp,0.dp,20.dp))
                informacion(campo = "Id_Usuario", valor = "122345", Icons.Rounded.AccountBox)
...
@Composable
fun informacion(campo: String, valor: String, icono: ImageVector){
    Row (modifier = Modifier.padding(30.dp,0.dp,0.dp,0.dp)){
        Icon(icono, contentDescription = "$campo", Modifier.size(40.dp))
        Text(text = "$valor", fontSize = 28.sp, modifier = Modifier.padding(14.dp,0.dp))
    }
}
